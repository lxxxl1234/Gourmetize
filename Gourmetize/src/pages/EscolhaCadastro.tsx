        ...
        <div className="relative z-10 w-full max-w-2xl rounded-3xl border border-white/20 dark:border-slate-700/50 bg-white/60 dark:bg-slate-900/60 backdrop-blur-md shadow-2xl px-8 py-10">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <Link 
              ...
              className="group relative overflow-hidden rounded-2xl border-2 border-emerald-200 hover:border-emerald-500 bg-emerald-50/50 hover:bg-emerald-100/70 p-6 transition-all duration-300 hover:shadow-lg hover:scale-105"
            >
              <div className="flex flex-col items-center text-center space-y-4">
                <div className="h-16 w-16 rounded-full bg-emerald-200 flex items-center justify-center group-hover:bg-emerald-300 transition-colors">
            ...
            >
              <div className="flex flex-col items-center text-center space-y-4">
                <div className="h-16 w-16 rounded-full bg-emerald-200 flex items-center justify-center group-hover:bg-emerald-300 transition-colors">
                  <BuildingStorefrontIcon className="h-10 w-10 text-emerald-700" />
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-emerald-900 mb-2">
                    Sou Produtor
          ...
          {/* Link para Login */}
          <p className="text-center text-sm text-emerald-700 mt-8">
            Já tem uma conta?{" "}
            <Link to="/login" className="font-semibold text-emerald-600 hover:text-emerald-800 underline transition">
              Faça login aqui
            </Link>
          </p>
        </div>
